...
public class LlmSummaryTarget {
    ...
    public String getBndTtl() { return bndTtl; }
    public void setBndTtl(String bndTtl) { this.bndTtl = bndTtl; }
    public String getJemok() { return jemok; }
    ...
    public String getOrgFilePath() { return orgFilePath; }
    public void setOrgFilePath(String orgFilePath) { this.orgFilePath = orgFilePath; }
