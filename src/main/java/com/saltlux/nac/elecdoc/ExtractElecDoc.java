...
public class ExtractElecDoc {
    ...
    public void setHasContents(String hasContents) {
    ...
    public String getExtractErrMsg() {
        return extractErrMsg;
    }

    public void setExtractErrMsg(String extractErrMsg) {
        this.extractErrMsg = extractErrMsg;
    }
}
